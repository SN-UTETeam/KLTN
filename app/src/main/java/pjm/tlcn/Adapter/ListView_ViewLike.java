...
public class ListView_ViewLike extends ArrayAdapter<User> {
    Activity context;
    int resource;
    List<User> items;
    DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference();

    public ListView_ViewLike(Activity context, int resource, List<User> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            viewHolder.img_avatar_viewlike = (ImageView) view.findViewById(R.id.img_avatar_viewlike);
            viewHolder.tv_username_viewlike = (TextView) view.findViewById(R.id.tv_username_viewlike);
